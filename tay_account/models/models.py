...
class account_customerbalancereport(models.TransientModel):
    ...
    def print_report(self, data,context=None):
        ...
        return self.env['report'].with_context(landscape=True).get_action(self, 'tay_account.report_cbr', data=data)

class customerbalancereport(models.AbstractModel):

    _name = 'report.tay_account.report_cbr'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('tay_account.report_cbr', docargs)
...
class account_vendorbalancereport(models.TransientModel):
    ...
    def print_report(self, data,context=None):
        data['form']=self.read(['date_from','date_end'])[0]
        return self.env['report'].with_context(landscape=True).get_action(self, 'tay_account.report_vbr', data=data)

class vendorbalancereport(models.AbstractModel):

    _name = 'report.tay_account.report_vbr'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('tay_account.report_vbr', docargs)
